	...
	template: `
		<div class="header">
	        ...
	        <div class="headerItems" id="headerContents">
	            <div class="flexCenter" id="headerAlarm" :style="{backgroundColor: headerMenuCheck[1] ? '#efefef' : '#ffffff'}" @click="alarmCheck()">
	            ...
	            <div class="flexCenter" id="headerProfile" :style="{ backgroundColor: headerMenuCheck[2] ? '#efefef' : '#ffffff' }" @click="profileCheck()">
