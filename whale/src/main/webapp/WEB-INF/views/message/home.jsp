...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/message/messageHome.css" />
<style>
.container {
	padding: 20px 20px;
}
...
<body>
	<div class="container">
		<div class="header">
			...
			<a href="${pageContext.request.contextPath}/message/newChat"
				id="new-chat"> <img
				src="${pageContext.request.contextPath}/static/images/message/newchatIcon.png"
				id="newchat" alt="newchatIcon">
			</a>
		</div>
		...
		<div class="scroll-content" id="chatList">
			<c:forEach var="list" items="${allChatList}">
				<a
					href="${pageContext.request.contextPath}/messageGo?u=${list.user_id}">
					<div class="room-list" id="chat-${list.user_id}"
						data-read-id="${list.unread_message_count}">
						<img
							src="${list.user_image_url}"
							alt="user-img">
						<div class="chat">
